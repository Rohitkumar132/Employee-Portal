...
const addStore = async (req, res, next) => {
    const data = req.user;
    const { firstName, lastName, name, store_code, address, storeImage, city, state, zipcode, timezone, email, phoneNumber, date_added, activation_date, lock_date, store_lock_reason, store_config_completed, nest_account, store_phoneNumber, pos_name, pos_qty, timings, timings_category } = req.body
